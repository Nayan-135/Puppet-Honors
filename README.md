...
├── nayan_level1_digital_fingerprint.pp  # Level 1 — File creation and idempotency
├── nayan_level2_service_lock.pp         # Level 2 — Service enforcement
├── nayan_level3_registry.pp             # Level 3 — Windows Registry management
├── nayan_level4_silent_installer.pp     # Level 4 — Silent software installation
├── nayan_level5_identity_report.pp      # Level 5 — Facts-driven configuration
├── nayan_boss_self_healing_website.pp   # Boss Level — IIS self-healing web server
...
```powershell
.\deploy-manifest.ps1 -ManifestFile nayan_level1_digital_fingerprint.pp
```

### Level 1 — The Digital Fingerprint (`nayan_level1_digital_fingerprint.pp`)
...
### Level 2 — The Service Lock (`nayan_level2_service_lock.pp`)
...
### Level 3 — Secret Agent Registry (`nayan_level3_registry.pp`)
...
### Level 4 — The Silent Installer (`nayan_level4_silent_installer.pp`)
...
### Level 5 — The Identity Report (`nayan_level5_identity_report.pp`)
...
### Boss Level — The Self-Healing Website (`nayan_boss_self_healing_website.pp`)
